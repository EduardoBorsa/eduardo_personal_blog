defmodule EduardoPersonalBlog.ContentTest do
  use EduardoPersonalBlog.DataCase

  alias EduardoPersonalBlog.Content

  describe "posts" do
    alias EduardoPersonalBlog.Content.Post

    import EduardoPersonalBlog.ContentFixtures
